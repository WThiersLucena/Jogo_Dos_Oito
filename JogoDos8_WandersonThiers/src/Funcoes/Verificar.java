...
public class Verificar {
	...
	public static boolean verificarEntrada(int linhaEspacoBranco, int colunaEspacoBranco, int linhaValorInserido,
			int colunaValorInserido) {

		if (linhaEspacoBranco == linhaValorInserido && colunaEspacoBranco == colunaValorInserido) {
			return false;
		}

		if ((linhaValorInserido > 2) || (linhaValorInserido < 0) || (colunaValorInserido > 2)
				|| (colunaValorInserido < 0)) {
			return false;
		}
